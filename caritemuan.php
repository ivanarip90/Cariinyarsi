...
$barang = query("SELECT * FROM temuan WHERE status !='Menunggu Konfirmasi'  && status != 'Ditolak' && status != 'Diklaim'");
...
if (isset($_POST["cari"])) {
    ...
    $query = "SELECT * FROM temuan WHERE 
...
<section>
    <div class="container">
        <div class="row mb-2 mt-3">
            <div class="col">
                <h2 class="display-4 lh-1 mb-2">Data Barang Temuan</h2>
            </div>
        </div>
        <div class="row mb-5 mt-3">
            <div class="col">
                ...
                <button class="btn btn-primary mt-3" name="cari" hidden>Cari temuan</button>
                </form>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <?php 
            foreach ($barang as $temuan):?>
            <div class="col-md-4 gx-3 mt-3">
                <div class="card">
                <img src="fileuploaded/<?= $temuan['foto'];?>" class="card-img-top" alt="..." width="auto" height="300px">
                <div class="card-body">
                    <h5 class="card-title mb-0"><?= $temuan['judul'];?></h5>
                    
                    <div class="d-flex bd-highlight">
                    <div class="p-2 pt-0 ps-0 flex-grow-1 bd-highlight">
                    <small class="p-0 mb-2"><?= $temuan['tanggal'];?></small>
                    </div>
                    <div class="card-text p-2 pt-0 bd-highlight">
                    <span  class="badge bg-primary">
                    <small class="p-2 mb-2"><b>Ditemukan di : </b><?= $temuan['tempat'];?></small>
                    </span></div>
                    </div>
                    <p class="card-text p-0 mb-2"><span  class="badge bg-primary"><b>Dapat diambil di : </b><?= $temuan['pengambilanbarang'];?>
                    <div class="card-text p-0 pt-0 bd-highlight">
                    </div>
                    <p class="card-text p-0 mb-2"><span  class="badge bg-primary"><b>Dapat menghubungi di nomor: </b><?= $temuan['no_hp'];?>
                    <div class="card-text p-0 pt-0 bd-highlight">
                    <small class="p-0 mb-2"><b>Merek : </b><?= $temuan['merek'];?></small>
                    </span></div>
                    <div class="card-text p-0 pt-0 bd-highlight">
                    <small class="p-0 mb-2"><b>Tahun : </b><?= $temuan['tahun'];?></small>
                    </span></div>
                    <div class="card-text p-0 pt-0 bd-highlight">
                    <small class="p-0 mb-2"><b>Warna : </b><?= $temuan['warna'];?></small>
                    </span></div>
                    <p class="card-text mt-3 mb-0"><b>Detail Temuan</b></p>
                    ...
                    <div class="p-2 pt-0 ps-0 flex-grow-1 bd-highlight"><span  class="badge bg-success"  ><?= $temuan['kategori'];?></span></div>
                    </div>
                    <div class="d-flex bd-highlight mt-0">
                    <div class="p-2 pt-0 ps-0 flex-grow-1 bd-highlight"><i class="bi bi-person-fill text-success me-2"></i><small><?= $temuan['pengunggah'];?></small></div>
                    
                    <div class="p-2 pt-0 bd-highlight">
                    
                    <?php 
                    if($temuan['status']=="Diklaim"):
                    ?>
                    <span class="badge bg-danger p-1 ps-2 pe-2"><?=$temuan['status'];?></span>
                    <?php endif;?>
                    </div>
                    </div>
                </div>
