...
$id=$_GET['kategori'];
$barang = query("SELECT * FROM temuan WHERE status !='Menunggu Konfirmasi' AND kategori ='$id'");
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 gx-3 mt-3">
                <div class="card">
                <img src="assets/img/<?= $temuan['foto'];?>" class="card-img-top" alt="..." width="auto" height="300px">
                <div class="card-body">
                    ...
                    <small class="p-0 mb-2"><?= $temuan['tempat'];?></small>
                    </span></div>
                    </div>
