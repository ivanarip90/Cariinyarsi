...
$barang = query("SELECT * FROM hilang WHERE status !='Menunggu Konfirmasi' && status != 'Ditolak' && status != 'Diklaim'");
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 gx-3 mt-3">
                <div class="card">
                <img src="fileuploaded/<?= $hilang['foto'];?>" class="card-img-top" alt="..." width="auto" height="300px">
                <div class="card-body">
                    ...
                    <small class="p-2 mb-2"><b>Ditemukan di : </b><?= $hilang['tempat'];?></small>
                    </span></div>
                    </div>
                    <p class="card-text p-0 mb-2"><span  class="badge bg-primary"><b>Dapat diambil di : </b><?= $hilang['pengambilanbarang'];?>
                    <div class="card-text p-0 pt-0 bd-highlight">
                    </div>
                    <p class="card-text p-0 mb-2"><span  class="badge bg-primary"><b>Dapat menghubungi di nomor: </b><?= $hilang['no_hp'];?>
                    <div class="card-text p-0 pt-0 bd-highlight">
                    <small class="p-0 mb-2"><b>Merek : </b><?= $hilang['merek'];?></small>
                    </span></div>
                    <div class="card-text p-0 pt-0 bd-highlight">
                    <small class="p-0 mb-2"><b>Tahun : </b><?= $hilang['tahun'];?></small>
                    </span></div>
                    <div class="card-text p-0 pt-0 bd-highlight">
                    <small class="p-0 mb-2"><b>Warna : </b><?= $hilang['warna'];?></small>
                    </span></div>
                    <p class="card-text mt-3 mb-0"><b>Detail Kehilangan</b></p>
